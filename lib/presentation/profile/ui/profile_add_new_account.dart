...
class ProfileAddNewAccountScreen extends StatefulWidget {
  const ProfileAddNewAccountScreen({super.key});
  ...
  @override
  State<ProfileAddNewAccountScreen> createState() =>
      _ProfileAddNewAccountScreenState();
}

class _ProfileAddNewAccountScreenState
    extends State<ProfileAddNewAccountScreen> {
    ...
    return BlocListener<ProfileCubit, ProfileState>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: TextStyles.header3(text: "Add new wallet"),
        ),
        bottomSheet: Container(
          ...
          child: ButtonStyles.ButtonNotIcon(
              ...
              label: "Continue",
              onTap: () {
                context.read<ProfileCubit>().insertNewWallet(
        ...
        body: ListView(
          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                key: ProfileAddNewAccountScreen._balanceFormKey,
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFieldCustom.textFieldNormal(
                      key: ProfileAddNewAccountScreen._nameFormKey,
                      controller: textEditingControllerName,
                      focusNode: focusName,
                      hint: "Name",
                      onTap: () {
                        Scrollable.ensureVisible(ProfileAddNewAccountScreen
                            ._nameFormKey.currentContext!);
                      }),
                  SizedBox(
                    height: 15.h,
                  ),
                  DropdownButtonFormField(
                    key: ProfileAddNewAccountScreen._bankFormKey,
                    ...
                    onChanged: (newValue) {
                      ...
                      Scrollable.of(ProfileAddNewAccountScreen
                          ._bankFormKey.currentContext!);
                      context
                          .read<ProfileCubit>()
