  ...
  Widget build(BuildContext context) {
    return BlocListener<IncomeCubit, IncomeState>(
      listener: (context, state) {
        final statusInsert = state.insertIncome.status;
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title:
              TextStyles.header3(text: "Income", fontWeight: FontWeight.bold),
        ),
                          ...
                          return DropdownButtonFormField(
                            ...
                            items: data?.map((WalletBankModel wallet) {
                              return DropdownMenuItem(
                                  value: wallet, child: Text(wallet.nameBank));
                            }).toList(),
                            onChanged: (newValue) {
                              walletData = newValue;
                            },
                          ...
                          child: Stack(
                            children: [
                              ...
                              Positioned(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    context.read<IncomeCubit>().clearImage();
                                  },
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              ModalBottom.modalBottomSheetAttachment(
                                ...
                                onTapImage: () {
                                  context.read<IncomeCubit>().openImage();
          ...
          child: ButtonStyles.ButtonNotIcon(
            ...
            onTap: () {
              if (textEditingControllerBalance.text.isEmpty) {
                ...
                context.read<IncomeCubit>().insertIncome(
